...
public class TestFile {
    ...
    public static String getFileText() {
        ...
        sb.append(LF);
        sb.append("Darmstadt is the site of one of the leading German universities, the [[Darmstadt University of Technology]], renowned for its engineering departments and the [[Darmstadt University of Applied Sciences]]. Related institutes are the [[Gesellschaft f������r Schwerionenforschung]] (see also 'Trivia', below) and the four Institutes of the [[Fraunhofer Society]]. The European Space Operations Center ([[ESOC]]) of the [[European Space Agency]] is located in Darmstadt, as is [[EUMETSAT]], which operates [[meteorological]] [[satellite]]s. Darmstadt is a centre for the pharmaceutical and chemical industry, with [[Merck KGaA|Merck]], R������hm and Schenck RoTec (part of The D������rr Group) having their main plants and centres here.");
        sb.append(LF);
        sb.append("The [http://www.jazzinstitut.de Jazz-Institut Darmstadt] is Germany's largest publicly accessible [[Jazz]] archive.");
        sb.append(LF);
        sb.append("The [http://www.imd.darmstadt.de/ Internationales Musikinstitut Darmstadt], harboring one of the world's largest collections of [[post-war]] [[sheet music]], also hosts the biannual ''[[International Summer Courses for New Music|Internationale Ferienkurse f������r Neue Musik]]'', a summer school in [[contemporary classical music]] founded by [[Wolfgang Steinecke]]. A large number of avant-garde [[composer]]s have attended and given lectures there, including [[Olivier Messiaen]], [[Luciano Berio]], [[Milton Babbitt]], [[Pierre Boulez]], [[John Cage]], [[Gy������rgy Ligeti]], [[Iannis Xenakis]], [[Karlheinz Stockhausen]] and [[Mauricio Kagel]].");
        sb.append(LF);
        sb.append("The [http://www.deutscheakademie.de/ Deutsche Akademie f������r Sprache und Dichtung] (German Academy for Language and Poetry) provides writers and scholars with a place to research the German language. The Academy's annual ''Georg-B������chner-Preis'', named in memory of [[Georg B������chner]], is considered the most renowned literary award for writers of German language.");
        sb.append(LF);
        sb.append(LF);
        ...
        sb.append(LF);
        sb.append("* Georg B������chner, German Poet");
        sb.append(LF);
        sb.append("* [[Dr Walter K������bel]], German  politician");
        sb.append(LF);
        sb.append("* [[August Anton Ullrich]], German industrialist (1865-1919)");
        sb.append(LF);
        sb.append("* [[Fabian Scheuermann]], World traveller");
        sb.append(LF);
        sb.append("* [[Bj������rn Phau]], Tennis player");
        sb.append(LF);
        sb.append("* [[Friedrich August Kekul������ von Stradonitz]], Organic Chemist");
        sb.append(LF);
        sb.append(LF);
        sb.append("== Military ==");
        sb.append(LF);
        ...
        sb.append(LF);
        sb.append("*{{flagicon|Spain}}[[Logro������o]], [[Spain]]");
        sb.append(LF);
        sb.append("*{{flagicon|Poland}}[[P������ock]], [[Poland]]");
        sb.append(LF);
        ...
        sb.append(LF);
        sb.append("* [http://www.deutscheakademie.de/ Deutsche Akademie f������r Sprache und Dichtung]");
        sb.append(LF);
        sb.append("* [http://www.gsi.de/ Gesellschaft f������r Schwerionenforschung]");
        sb.append(LF);
