...
//		}
		...
		private boolean fillBuffer() {
			...
			if(loadFromList){
		        ...
		        if (onlyArticles) {
		            returnValues = session.createCriteria(org.epnoi.uia.harvester.wikipedia.parse.de.tudarmstadt.ukp.wikipedia.api.hibernate.Page.class)
		        ...
		        for(Object o : returnValues){
		        	if(o==null) {
		        		...
		        		org.epnoi.uia.harvester.wikipedia.parse.de.tudarmstadt.ukp.wikipedia.api.hibernate.Page hibernatePage = (org.epnoi.uia.harvester.wikipedia.parse.de.tudarmstadt.ukp.wikipedia.api.hibernate.Page) o;
