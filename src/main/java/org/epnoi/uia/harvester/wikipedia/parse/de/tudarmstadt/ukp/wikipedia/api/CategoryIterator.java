...
//TODO test whether this works when zero pages are retrieved
        ...
        private boolean fillBuffer() {
            ...
            returnValues = session.createCriteria(org.epnoi.uia.harvester.wikipedia.parse.de.tudarmstadt.ukp.wikipedia.api.hibernate.Category.class)
            ...
            for(Object o : returnValues){
                if(o==null) {
                	...
                	org.epnoi.uia.harvester.wikipedia.parse.de.tudarmstadt.ukp.wikipedia.api.hibernate.Category hibernateCategory = (org.epnoi.uia.harvester.wikipedia.parse.de.tudarmstadt.ukp.wikipedia.api.hibernate.Category) o;
