...
public class RSSHarvester {
	...
	public RSSHarvester(RSSHarvesterParameters parameters) {
	...
	public void _harvestDirectory(File directoryToHarvest, Manifest manifest) {
		try {
			...
			/*
			 * String[] filesToHarvest =
			 * scanFilesToHarverst(directoryToHarvest); System.out
			 * .println("..........> " + Arrays.toString(filesToHarvest)); for
			 * (String fileToHarvest : filesToHarvest) {
	...
	class RSSHarvestTask extends TimerTask {
		...
		/*
		 * public void _initializeHoarding() { String manifestPath =
		 ...
		 * System.out.println("directory -> " + harvestDirectoryName); File
		 * harvestDirectory = new File(harvestDirectoryName); if
		 * (!harvestDirectory.exists()) { boolean created =
		 * harvestDirectory.mkdirs(); System.out.println("Directory created? " +
		 * created); }
		 * 
		...
		public List<Item> _harvestFile(String filePath) {
			 ...
			 * 
			 * System.out .println("Showing " + message.getTitle() +
			 * "---------------------------------------------------------------"
	...
	public static void main(String[] args) {
		...
		RSSHarvester harvester = new RSSHarvester(parameters);
		harvester.start();
	}
