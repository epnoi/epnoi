...
public class OntologyLearningParameters extends Parameters {
	...
	// Minimum probability for a detected hypernym relation to be consider for being expanded in the ontology learning process
	...
	// Domain that is the target of the ontology learning process
