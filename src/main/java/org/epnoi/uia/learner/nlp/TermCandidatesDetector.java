...
public class TermCandidatesDetector {
	...
	public void init() {
		...
		String documentsPath = TermCandidatesDetector.class.getResource("").getPath()+"/documents";
	...
	public static void main(String[] args) {
		...
		TermCandidatesDetector app = new TermCandidatesDetector();
		app.init();
