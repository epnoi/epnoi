    ...
    protected RouteBuilder createRouteBuilder() {
        return new RouteBuilder() {
            public void configure() {
                ...
                from("direct:start").
                        setProperty(Record.SOURCE_NAME, constant("ucm")).
                        setProperty(Record.SOURCE_URI, constant("http://www.epnoi.org/oai-providers/ucm")).
                        setProperty(Record.SOURCE_URL, constant("http://eprints.ucm.es/cgi/oai2")).
